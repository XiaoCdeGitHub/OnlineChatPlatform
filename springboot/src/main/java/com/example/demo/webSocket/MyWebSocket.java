...
public class MyWebSocket {
    ...
    private static UserInfoServicesI userInfoServicesI;
    @Autowired
    public void setChatMessageService(ChatMessageService chatMessageService) {
        MyWebSocket.chatMessageService = chatMessageService;
    }
    @Autowired
    public void setUserInfoServicesI(UserInfoServicesI userInfoServicesI) {
        MyWebSocket.userInfoServicesI = userInfoServicesI;
    }
